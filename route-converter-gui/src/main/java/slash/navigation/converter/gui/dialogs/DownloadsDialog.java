...
public class DownloadsDialog extends SimpleDialog {
    ...
    public DownloadsDialog() {
        super(BaseRouteConverter.getInstance().getFrame(), "downloads");
        setTitle(BaseRouteConverter.getBundle().getString("downloads-title"));
        ...
        for (int i = 0; i < columns.getColumnCount(); i++) {
            ...
            if (i == SIZE_COLUMN) {
                ...
                int width = getMaxWidth("Downloading", 2);
                column.setPreferredWidth(width);
                column.setMaxWidth(width);
            }
        }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.setLayout(new GridLayoutManager(1, 3, new Insets(2, 0, 1, 0), -1, -1));
        ...
        panel1.add(buttonClose, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
