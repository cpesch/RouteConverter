...
public class AboutTimeAlbumProDialog extends SimpleDialog {
    ...
    public AboutTimeAlbumProDialog() {
        ...
        if (featuredTo != null) {
            labelFeature.setText(format(BaseRouteConverter.getBundle().getString("featured-to"), featuredTo));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadLabelText$$$(labelAbout,
                this.$$$getMessageFromBundle$$$("slash/navigation/converter/gui/RouteConverter", "about-timealbum-pro"));
        panel1.add(labelAbout,
                new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED,
                        GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        labelContact = new JLabel();
        this.$$$loadLabelText$$$(labelContact,
                this.$$$getMessageFromBundle$$$("slash/navigation/converter/gui/RouteConverter", "about-timealbum-contact"));
        ...
        panel1.add(separator1, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
        ...
        panel1.add(panel2, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
