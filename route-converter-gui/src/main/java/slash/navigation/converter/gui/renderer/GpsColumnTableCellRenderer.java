...
public class GpsColumnTableCellRenderer extends AlternatingColorTableCellRenderer {
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int rowIndex, int columnIndex) {
        ...
        if(tagState.equals(Tagged))
            text = MessageFormat.format(BaseRouteConverter.getBundle().getString("gps-data-tagged"),
            ...
            text = MessageFormat.format(BaseRouteConverter.getBundle().getString("gps-data-taggable"),
            ...
            text = MessageFormat.format(BaseRouteConverter.getBundle().getString("gps-data-nottaggable"),
                    formatDate(position.getTime()), formatTime(position.getTime()));
        label.setText(text);
