...
public class PointsOfInterestTableColumnModel extends AbstractTableColumnModel {
    public PointsOfInterestTableColumnModel(PositionsModelCallback positionsModelCallback) {
        super(POINTS_OF_INTEREST, positionsModelCallback);
        ...
        predefineColumn(DATE_TIME_COLUMN_INDEX, "datetime", getMaxWidth(getExampleDateTimeFromCurrentLocale(), 10), false, new GenericColumnTableCellEditor(), headerRenderer);
