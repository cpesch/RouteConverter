...
public class LocalRouteDistanceAndTimeFiller {
    ...
    private final ExecutorService executor = new ThreadPoolExecutor(1, 1, 60, SECONDS,
    ...
    public LocalRouteDistanceAndTimeFiller(RouteDistanceAndTimeCache cache, Consumer<String> urlUpdated) {
        this(cache, LocalRouteDistanceAndTimeFiller::parseLocalRoute, urlUpdated);
    }

    LocalRouteDistanceAndTimeFiller(RouteDistanceAndTimeCache cache, Function<String, DistanceAndTime> parser,
                                    Consumer<String> urlUpdated) {
        this.cache = cache;
        this.parser = parser;
