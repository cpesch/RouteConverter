...
public class ExternalPrograms {
    ...
    public static void startBrowser(Window window, String uri) {
        try {
            ...
            showError(window,
                    MessageFormat.format(BaseRouteConverter.getBundle().getString("start-browser-error"), getLocalizedMessage(e)),
    ...
    private static void startMail(Window window, String uri) {
        try {
            ...
            showError(window,
                    MessageFormat.format(BaseRouteConverter.getBundle().getString("start-mail-error"), getLocalizedMessage(e)),
                    BaseRouteConverter.getTitle());
        }
    }
}
