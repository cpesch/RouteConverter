...
public class ColorHelperTest {
    ...
    private static final Color WAYPOINT_COLOR = new Color(decodeInt("00000000"), true);
    ...
    @Test
    public void testAsAlpha() {
        assertEquals(0.8, asAlpha(ROUTE_COLOR), 0.05);
        assertEquals(1.0, asAlpha(TRACK_COLOR), 0.05);
        assertEquals(0.3, asAlpha(WAYPOINT_COLOR), 0.05);
    }
}
