...
public class DataSourceServiceIT {
    ...
    public void setUp() throws Exception {
        ...
        service.initialize(getClass().getResourceAsStream("testdatasources.xml"));
    }
    ...
    private void checkMappingType(Map<String, String> mapping, String... keyValues) {
        for (int i = 0; i < keyValues.length; i += 2) {
            String key = keyValues[i];
            String value = keyValues[i + 1];
            assertEquals(value, mapping.get(key));
        }
    }
    ...
    public void testBaseUrl() throws IOException {
        ...
        checkMappingType(service.getMapping("1"), "a", "x/y/z.data");
        checkMappingType(service.getMapping("2"), "b", "x/y/z.data", "c", "z/y/x.data");
        checkMappingType(service.getMapping("3"));
    }
}
