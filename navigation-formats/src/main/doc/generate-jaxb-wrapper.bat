...
bin\xjc -cp lib\jaxb-impl.jar -verbose -d c:\Development\RouteConverter\browser-mapview\src\main\java -p main.java.slash.navigation.maps.tileserver.binding c:\Development\RouteConverter\browser-mapview\src\main\doc\tileserver-catalog.xsd
