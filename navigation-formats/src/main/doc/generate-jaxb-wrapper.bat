...
bin\xjc -cp lib/jaxb-impl.jar -verbose -d c:\p4\RouteConverter\gpx\src\main\java -p slash.navigation.gpx.trip1 c:\p4\RouteConverter\gpx\src\main\doc\TripExtensionsv1.xsd
