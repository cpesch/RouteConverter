...
public class BcrPosition extends MercatorPosition {
    ...
    public BcrPosition(Double longitude, Double latitude, Double elevation, String comment) {
    ...
    public GoPalPosition asGoPalRoutePosition() {
        return new GoPalPosition(getX(), getY(), null, getZipCode(), getCity(), getStreet(), null);
    }
