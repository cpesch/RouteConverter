...
public class GoogleMapsFormatTest extends NavigationTestCase {
    ...
    public void testParseSingleURLParameters() {
        Map<String, List<String>> parameters = format.parseURLParameters("f=d", "ISO8859-1");
    ...
    public void testParseTwoURLParameters() {
        Map<String, List<String>> parameters = format.parseURLParameters("f=d&g=e", "UTF-8");
        assertNotNull(parameters);
    ...
    public void testParseSetURLParameters() {
        Map<String, List<String>> parameters = format.parseURLParameters("f=d&f=e", "ISO8859-1");
        assertNotNull(parameters);
        List<String> fValues = parameters.get("f");
        assertNotNull(fValues);
    ...
    public void testParseStartPosition() {
        String comment = "Hˆlderlinstraﬂe, 51545 Brˆl, Oberbergischer Kreis, Nordrhein-Westfalen, Deutschland";
    ...
    public void testParseCoordinateStartPosition() {
        String comment = "L1042/Langensaltzaer Straﬂe @51.125340, 10.480100";
        Wgs84Position position = format.parseStartPosition("50.954318,7.311401", comment);
        assertEquals(10.4801, position.getLongitude());
        assertEquals(51.125340, position.getLatitude());
        assertEquals("L1042/Langensaltzaer Straﬂe", position.getComment());
    }

    public void testParseDestinationPosition() {
        Wgs84Position position = format.parsePosition("L339/Wuppertaler Straﬂe @50.918890,7.560880 ");
    ...
    public void testParseDestinationPositions() {
        List<Wgs84Position> positions = format.parseDestinationPositions("L339/Wuppertaler Straﬂe @50.918890,7.560880 to: B @ -1.1 , -2.2to:C@3.3,4.4");
    ...
    public void testCreateURL() {
        ...
        positions.add(new Wgs84Position(53.57497745, 10.02571156, null, 5.5, new GregorianCalendar(), "Hamburg, Germany"));
        positions.add(new Wgs84Position(53.57662034, 10.20026067, null,4.5, new GregorianCalendar(), "Stemwarde, Germany"));
        positions.add(new Wgs84Position(53.59171021, 10.35735078, null,3.5, new GregorianCalendar(), "Groﬂensee, Germany"));
        positions.add(new Wgs84Position(53.64781001, 10.45696089, null,2.5, new GregorianCalendar(), "Linau, Germany"));
