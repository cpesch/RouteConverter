...
public class MagellanRouteFormatTest {
    ...
    public void testParsePMGNWPL() {
        ...
        assertDoubleEquals(4808.98261, position.getLatitudeAsValueAndOrientation().value());
        assertDoubleEquals(1135.84141, position.getLongitudeAsValueAndOrientation().value());
