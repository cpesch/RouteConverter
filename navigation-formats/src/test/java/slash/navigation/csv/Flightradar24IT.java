...
public class Flightradar24IT {
    ...
    @Test
    public void testCheckAllFlightradar24CsvAgainstKml() throws IOException {
    ...
    private void checkEquals(BaseRoute<?, ?> csvRoute, BaseRoute<?, ?> kmlRoute) {
        ...
        String[] parts = csvRoute.getName().split(" ");
        String csvRouteName = parts.length > 0 ? parts[0] : csvRoute.getName();
        assertTrue(kmlRoute.getName().contains(csvRouteName));
