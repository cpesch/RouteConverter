...
public class MG2009IntranetTest {
    ...
    public void testIsSectionTitle() {
        assertTrue(format.isSectionTitle("[TIMEWINDOW]"));
        assertTrue(format.isSectionTitle("[STAYTIME]"));
        assertTrue(format.isSectionTitle("[SOFT VIAPOINTS]"));
        assertTrue(format.isSectionTitle("[LINKTYPES]"));
