...
<!-- Shipped in PR #139 (squash-merged to master). Manual UI check of the
     BUTTON1_MASK -> BUTTON1_DOWN_MASK right-click-without-selection path:
     confirmed working by the maintainer. -->
