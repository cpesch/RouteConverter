...
java -jar download-tools\target\CreateGraphHopperDataSourcesXml.jar "GraphHopper" "http://download.geofabrik.de/" "graphhopper" "W:\Mirrors\download.geofabrik.de" "graphhopper\src\main\resources\slash\navigation\graphhopper\graphhopper-datasources.xml"
