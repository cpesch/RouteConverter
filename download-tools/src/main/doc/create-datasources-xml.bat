...
java -jar download-tools\target\CreateThemeDataSourcesXml.jar "freizeitkarte-themes" "Freizeitkarte Themes" "http://download.freizeitkarte-osm.de/android/1408/" "themes/freizeitkarte" "C:\Temp\freizeitkarte-themes-datasources.xml"
java -jar download-tools\target\CreateThemeDataSourcesXml.jar "openandromaps-themes" "Openandromaps Themes" "http://www.openandromaps.org/kartenlegende/" "http://www.openandromaps.org/kartenlegende/" "themes/openandromaps" "C:\Temp\openandromaps-themes-datasources.xml"
