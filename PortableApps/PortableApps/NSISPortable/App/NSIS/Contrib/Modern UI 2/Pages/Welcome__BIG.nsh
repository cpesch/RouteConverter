...
!macro MUI_FUNCTION_WELCOMEPAGE PRE LEAVE
  ...
  Function "${PRE}"
    ...
    ;Title
    ${NSD_CreateLabel} 120u 10u 295u ${MUI_WELCOMEPAGE_TITLE_HEIGHT}u "${MUI_WELCOMEPAGE_TITLE}"
    ...
    ;Welcome text
    ${NSD_CreateLabel} 120u ${MUI_WELCOMEPAGE_TEXT_TOP}u 295u 130u "${MUI_WELCOMEPAGE_TEXT}"
