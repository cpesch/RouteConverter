/**
 * Contains the <a href="https://jaxb.dev.java.net/nonav/2.2.4/docs/api/">JAXB</a> binding for the trekbuddy GPX extensions 0.9.84.
 */
@jakarta.xml.bind.annotation.XmlSchema(namespace = TREKBUDDY_EXTENSIONS_0984_NAMESPACE_URI, elementFormDefault = QUALIFIED, xmlns = {
