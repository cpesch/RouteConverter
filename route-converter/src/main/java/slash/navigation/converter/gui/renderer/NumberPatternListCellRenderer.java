...
/**
 * Renders the {@link NumberPattern} labels of the language combo box.
 *
...
public class NumberPatternListCellRenderer extends DefaultListCellRenderer {
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        String text = RouteConverter.getBundle().getString("number-pattern-" + numberPattern.toString().toLowerCase());
        label.setText(text);
        return label;
    }
}
