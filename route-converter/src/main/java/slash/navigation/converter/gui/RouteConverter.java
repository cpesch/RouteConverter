...
public abstract class RouteConverter extends SingleFrameApplication {
    ...
    private static final String SHOWED_MISSING_TRANSLATOR_PREFERENCE = "showedMissingTranslator-2.24"; // versioned preference
    public static final String AUTOMATIC_UPDATE_CHECK_PREFERENCE = "automaticUpdateCheck-2.24";
    ...
    protected void checkJavaPrequisites() {
        ...
        if (!isCurrentAtLeastMinimumVersion(currentVersion, "1.8.0")) {
            showMessageDialog(null, "Java " + currentVersion + " is too old for FIT and EclipseLink. Please install Java 8 or later.", "RouteConverter", ERROR_MESSAGE);
            System.exit(7);
        }
    }
