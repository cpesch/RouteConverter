...
public class DeleteMapsAction extends DialogAction {
    ...
    public void run() {
        ...
        int confirm = showConfirm(getDialog(), format(BaseRouteConverter.getBundle().getString("confirm-delete-maps"), mapNames),
        ...
        try {
            ...
            invokeLater(() -> {
                showError(getDialog(), format(BaseRouteConverter.getBundle().getString("cannot-delete-maps"), e), getDialog().getTitle());
            });
        }
    }
}
