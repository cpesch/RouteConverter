...
public class ThemeStyleDialog extends SimpleDialog {
    ...
    public ThemeStyleDialog() {
        super(BaseRouteConverter.getInstance().getFrame(), "style");
        $$$setupUI$$$();
        setTitle(BaseRouteConverter.getBundle().getString("theme-style-title"));
        setContentPane(contentPane);
        getRootPane().setDefaultButton(buttonClose);

        comboBoxStyle.setModel(new TableModelToComboBoxModelAdapter<>(getMapsforgeMapManager().getAvailableThemeStylesModel(),
                getMapsforgeMapManager().getAppliedThemeStyleModel()));
     ...
     * method free of type arguments the IDE would strip on its next regeneration.
     */
    ...
    private void $$$setupUI$$$() {
        ...
        contentPane.add(comboBoxStyle, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL,
        ...
        panel1.add(buttonClose, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL,
        ...
        this.$$$loadLabelText$$$(label2,
                this.$$$getMessageFromBundle$$$("slash/navigation/converter/gui/RouteConverter", "style-categories"));
        contentPane.add(label2, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_NORTHWEST, GridConstraints.FILL_NONE,
