...
public class LargeMailUserType {
    ...
    @XmlElement(name = "LargeMailUserName", namespace = "urn:oasis:names:tc:ciq:xsdschema:xAL:2.0")
    protected List<LargeMailUserType.LargeMailUserName> largeMailUserName;
    @XmlElement(name = "LargeMailUserIdentifier", namespace = "urn:oasis:names:tc:ciq:xsdschema:xAL:2.0")
    ...
    @XmlElement(name = "Department", namespace = "urn:oasis:names:tc:ciq:xsdschema:xAL:2.0")
