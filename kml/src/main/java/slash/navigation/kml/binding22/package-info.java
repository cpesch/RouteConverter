/**
 * Contains the <a href="https://jaxb.dev.java.net/nonav/2.2.4/docs/api/">JAXB</a> binding for the Kml22Format.
 */
@jakarta.xml.bind.annotation.XmlSchema(namespace = KML_22_NAMESPACE_URI, elementFormDefault = QUALIFIED, xmlns = {
		@XmlNs(prefix = "", namespaceURI = KML_22_NAMESPACE_URI),
