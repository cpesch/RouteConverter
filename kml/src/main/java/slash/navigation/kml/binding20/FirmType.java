...
@XmlType(name = "FirmType", namespace = "urn:oasis:names:tc:ciq:xsdschema:xAL:2.0", propOrder = {
    "addressLine",
    "firmName",
    "department",
    "mailStop",
...
public class FirmType {
    ...
    @XmlElement(name = "FirmName", namespace = "urn:oasis:names:tc:ciq:xsdschema:xAL:2.0")
