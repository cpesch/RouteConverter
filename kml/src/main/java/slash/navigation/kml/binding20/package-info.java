/**
 * Contains the <a href="https://jaxb.dev.java.net/nonav/2.2.4/docs/api/">JAXB</a> binding for the Kml20Format.
 */
@jakarta.xml.bind.annotation.XmlSchema(namespace = KML_20_NAMESPACE_URI, elementFormDefault = QUALIFIED, xmlns = {
		@XmlNs(prefix = "", namespaceURI = KML_20_NAMESPACE_URI),
