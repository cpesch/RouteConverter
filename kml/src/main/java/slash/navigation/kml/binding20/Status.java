...
public class Status {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "request", type = String.class)
    })
    protected List<Serializable> codeOrRequest;

    /**
     * Gets the value of the codeOrRequest property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the codeOrRequest property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCodeOrRequest().add(newItem);
     * </pre>
     * 
     * 
     * <p>
