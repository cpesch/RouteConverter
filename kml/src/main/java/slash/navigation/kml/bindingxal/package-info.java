/**
 * Contains the <a href="https://jaxb.dev.java.net/nonav/2.2.4/docs/api/">JAXB</a> binding for XAL.
 */
@jakarta.xml.bind.annotation.XmlSchema(namespace = XAL_20_NAMESPACE_URI, elementFormDefault = QUALIFIED, xmlns = {
