...
public interface PositionColumns {
    ...
    int HEART_BEAT_COLUMN_INDEX = 19;
    int HEADING_COLUMN_INDEX = 20;
    int HDOP_COLUMN_INDEX = 21;
    int QUALITY_COLUMN_INDEX = 22;
    int ACCELERATION_X_COLUMN_INDEX = 23;
    int ACCELERATION_Y_COLUMN_INDEX = 24;
    int ACCELERATION_Z_COLUMN_INDEX = 25;
    int SATELLITES_COLUMN_INDEX = 26;
