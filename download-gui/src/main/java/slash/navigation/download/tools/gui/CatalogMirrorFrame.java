...
public class CatalogMirrorFrame {
    ...
    private String buildDetails(MirrorJobRow row) {
        ...
        builder.append("Total size: ").append(formatSize(info.totalSize())).append('\n');
    ...
    private void appendLog(String message) {
        textAreaLog.append("[" + formatTime(CompactCalendar.now()) + "] " + message + "\n");
