...
public class PhotonServiceIT {
    ...
    public void getPositionsFor() throws IOException {
        List<SimpleNavigationPosition> expected = asList(
                new SimpleNavigationPosition(10.2014032, 50.0002123, null, "B\u00fchlstra\u00dfe, 97506 Grafenrheinfeld, Free State of Bavaria, Germany (highway)"),
                new SimpleNavigationPosition(10.200847241161895, 50.0011614, null, "Pfarrheim, 97506 Grafenrheinfeld, Free State of Bavaria, Germany (building)"),
                new SimpleNavigationPosition(10.2004901, 50.0014652, null, "Kindertagesst\u00e4tte St. Joseph, 97506 Grafenrheinfeld, Free State of Bavaria, Germany (amenity)")
        );
    ...
    public void getAddressFor() throws IOException {
        ...
        assertEquals("B\u00fchlstra\u00dfe, 97506 Grafenrheinfeld, Free State of Bavaria, Germany", service.getAddressFor(new SimpleNavigationPosition(10.2, 50.001)));
        assertEquals("Hoher Gaif, Garmisch-Partenkirchen, Free State of Bavaria, Germany", service.getAddressFor(new SimpleNavigationPosition(11.06561, 47.42428)));
        ...
        assertEquals("Unidade de Saúde Bairro Operário, 29147-670", service.getAddressFor(new SimpleNavigationPosition(-90.0, -90.0)));
